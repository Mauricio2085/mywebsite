  ...
  return (
    ...
    >
      <div className="flex w-full flex-1 flex-col text-center md:text-left">
        <h1 className="text-shadow mb-8 mt-4 text-3xl font-bold italic text-white md:text-[40px]">
          My Web Development Stack
        </h1>
        <p className="mb-20 text-sm font-normal text-gray-300 md:text-base">
          Modern frameworks and tools with which I develop my web apps efficiently and scalebly.
        </p>

        <div className="text-shadow grid w-full flex-1 grid-cols-2 gap-8 text-white md:grid-cols-4">
